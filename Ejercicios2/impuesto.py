...
pago_sin_impuesto = float(input("Por favor ingrese un valor neto: "))
impuesto = float(input("Por favor ingrese el impuesto: "))
pagar = 0

def calcular_total(pago_sin_impuesto, impuesto):
    global pagar
    iva = (pago_sin_impuesto * impuesto)/100
    pagar = pago_sin_impuesto + iva
    return pagar
